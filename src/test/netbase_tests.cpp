...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:40000", "127.0.0.1", 40000));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:40000", "127.0.0.1", 40000));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:40000", "::ffff:127.0.0.1", 40000));
    BOOST_CHECK(TestSplitHost("[::]:40000", "::", 40000));
    BOOST_CHECK(TestSplitHost("::40000", "::40000", -1));
    BOOST_CHECK(TestSplitHost(":40000", "", 40000));
    BOOST_CHECK(TestSplitHost("[]:40000", "", 40000));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:40000", "127.0.0.1:40000"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:40000", "[::]:40000"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
...
BOOST_AUTO_TEST_CASE(netbase_getgroup)
{
    ...
    BOOST_CHECK(ResolveIP("2002:102:304:40000:40000:40000:40000:40000").GetGroup(asmap) == std::vector<unsigned char>({(unsigned char)NET_IPV4, 1, 2})); // RFC3964
    BOOST_CHECK(ResolveIP("2001:0:40000:40000:40000:40000:FEFD:FCFB").GetGroup(asmap) == std::vector<unsigned char>({(unsigned char)NET_IPV4, 1, 2})); // RFC4380
    ...
    BOOST_CHECK(ResolveIP("2001:470:abcd:40000:40000:40000:40000:40000").GetGroup(asmap) == std::vector<unsigned char>({(unsigned char)NET_IPV6, 32, 1, 4, 112, 175})); //he.net
    BOOST_CHECK(ResolveIP("2001:2001:40000:40000:40000:40000:40000:40000").GetGroup(asmap) == std::vector<unsigned char>({(unsigned char)NET_IPV6, 32, 1, 32, 1})); //IPv6
