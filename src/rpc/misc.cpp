    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"debug",
                ...
                " - \"scc\" activates all SCC-specific categories at once;\n"
            ...
            "  result               (string) \"Debug mode: \" followed by the specified category.\n"
                ...
                RPCExamples {
                    HelpExampleCli("debug", "scc")
            + HelpExampleRpc("debug", "scc+net")
            }}.ToString());
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given scc address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The scc address to validate"},
                },
                RPCResult{
            "{\n"
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The scc address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "scc-cli and the GUI. There is no server-side difference.",
                {},
