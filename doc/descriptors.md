# Support for Output Descriptors in SCC Core

Since SCC Core v0.17, there is support for Output Descriptors. This is a
...
existing SCC Core wallets, a convenience function `combo` is
...
All RPCs in SCC Core will include the checksum in their output. Only
