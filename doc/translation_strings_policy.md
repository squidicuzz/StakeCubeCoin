...
This document provides guidelines for internationalization of the SCC Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `scc_en.ts` remains unchanged.
