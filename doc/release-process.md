...
- Detached signatures will then be committed to the [scc-detached-sigs](https://github.com/stakecube/StakeCubeCoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
