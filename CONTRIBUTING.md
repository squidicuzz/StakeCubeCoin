Contributing to SCC Core
============================

The SCC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SCC Core project (and related
projects such as libsecp256k1), and is not to be confused with overall SCC
Network Protocol consensus changes.

Whether a pull request is merged into SCC Core rests with the project merge
...
Patches that change SCC consensus rules are considerably more involved than
...
Where a patch set proposes to change the SCC consensus, it must have been
...
The review process is normally fairly responsive on the SCC Core repository, however
...
Bitcoin Backports are an incredibly valuable part of SCC's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for SCC](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each SCC Core release.
