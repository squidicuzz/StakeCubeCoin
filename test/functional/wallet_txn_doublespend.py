...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to send 12400 SCC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 SCC coin each
        ...
        # Node0's balance should be starting balance, plus 500 SCC for another
        ...
        # Node0's total balance should be starting balance, plus 1000 SCC for
