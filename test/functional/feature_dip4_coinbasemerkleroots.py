...
class LLMQCoinbaseCommitmentsTest(SCCTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as SCCTestFramework doesn't support this atm)
