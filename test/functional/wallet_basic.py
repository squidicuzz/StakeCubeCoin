...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 SCC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 SCC in block rewards plus fees, but
        ...
        # Send 100 SCC with subtract fee from amount
        ...
        # Sendmany 100 SCC with subtract fee from amount
        ...
        # This will raise an exception for attempting to get the private key of an invalid SCC address
        assert_raises_rpc_error(-5, "Invalid SCC address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid SCC address
        assert_raises_rpc_error(-5, "Invalid SCC address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid SCC address or script", self.nodes[0].importaddress, "invalid")
