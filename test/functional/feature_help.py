...
"""Verify that starting sccd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sccd with -h for help text")
        ...
        self.log.info("Start sccd with -version for version information")
        ...
        self.log.info("Start sccdd with -fakearg to make sure it does not start")
